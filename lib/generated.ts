...
export type RecipeQuery = { __typename?: 'Query', recipe: { __typename?: 'Recipe', title: string, image?: string | null, ingredients: Array<{ __typename?: 'Ingredient', name: string }>, instructions: Array<{ __typename?: 'Instruction', text: string }> } };
